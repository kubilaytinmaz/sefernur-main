...
class BlogCreateSheet extends StatefulWidget {
  final List<BlogCategory> presetCategories;
  const BlogCreateSheet({super.key, this.presetCategories = const [BlogCategory.hazirlik]});

  static Future<void> show({List<BlogCategory> categories = const [BlogCategory.hazirlik]}) async {
    Get.bottomSheet(
      BlogCreateSheet(presetCategories: categories),
  ...
  @override
  State<BlogCreateSheet> createState() => _BlogCreateSheetState();
}

class _BlogCreateSheetState extends State<BlogCreateSheet> {
  ...
  void initState() {
    super.initState();
    _categories = widget.presetCategories;
  }
  ...
  Future<void> _submit() async {
    ...
    final ok = await Get.find<BlogService>().addBlog(
